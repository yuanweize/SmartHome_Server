...
\noindent A snapshot of the repository at the time of submission (06-01-2026) is also attached to this thesis in the CTU DSpace archive system. 
...
This appendix presents key excerpts from the Python sensor simulator. The complete source code ($\sim$800 lines) is available in the project repository. For flowchart reference, see Figure~\ref{fig:simulator-flowchart}.
...
\IfFileExists{images/simpy.png}{%
    \includegraphics[width=0.95\linewidth]{images/simpy.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
...
\IfFileExists{images/broker_100_dash.png}{%
    \includegraphics[width=0.95\linewidth]{images/broker_100_dash.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
...
\IfFileExists{images/broker_100.png}{%
    \includegraphics[width=0.95\linewidth]{images/broker_100.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
...
\IfFileExists{images/HAOS_100.png}{%
    \includegraphics[width=0.95\linewidth]{images/HAOS_100.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
...
\IfFileExists{images/broker_1000_dash.png}{%
    \includegraphics[width=0.95\linewidth]{images/broker_1000_dash.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
...
\IfFileExists{images/broker_1000.png}{%
    \includegraphics[width=0.95\linewidth]{images/broker_1000.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
...
\IfFileExists{images/HAOS_1000.png}{%
    \includegraphics[width=0.95\linewidth]{images/HAOS_1000.png}%
}{%
    \fbox{\parbox{0.9\linewidth}{\centering
