...
\midrule
\multirow{5}{*}{MPU6050 (GY-521)} 
  & VCC & 3V3 & Power (2.4--3.5\,V) & Logic level compatible~\cite{mpu6050_datasheet_2013} \\
  & GND & GND & Ground & --- \\
...
\midrule
\multirow{5}{*}{TCS34725} 
  & VIN & 3V3 & Power (2.7--3.6\,V) & Onboard regulator~\cite{tcs34725_datasheet_2012} \\
  & GND & GND & Ground & --- \\
...
\midrule
\multirow{6}{*}{MQ-2 Gas} 
  & VCC & VIN (5V) & Heater power & \textbf{5\,V required}~\cite{mq2_datasheet_2014} \\
  & GND & GND & Ground & --- \\
  & AO & GPIO34 & Analog output & 0--3.3\,V proportional to gas \\
  & DO & --- & Digital output & Unused; AO provides finer resolution \\
  & H1/H2 & (internal) & Heater coil & $R_H = 31\,\Omega$; $P_H \leq 900$\,mW \\
\midrule
...
\multirow{4}{*}{RGB LED} 
  ...
  & COM & 3V3/GND & Common anode/cathode & Depends on LED type \\
\bottomrule
\end{tabular}%
}
\end{table}
